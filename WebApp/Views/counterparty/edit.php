                    ...
                    <div class="row mb-3 d-flex align-items-center">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" value="<?php echo $counterparty->name?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="fullname" class="form-label">Повне ім`я / назва</label>
                                        <input type="text" class="form-control" id="fullname" value="<?php echo  $counterparty->full_name;?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <input type="text" class="form-control" id="phone" value="<?php echo $counterparty->phone;?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <textarea rows="3" type="tex" class="form-control" id="description"><?php echo $counterparty->description;?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
